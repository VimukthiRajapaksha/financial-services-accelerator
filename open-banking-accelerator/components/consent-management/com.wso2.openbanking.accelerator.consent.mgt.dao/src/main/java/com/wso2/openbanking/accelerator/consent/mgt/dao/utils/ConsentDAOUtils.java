...
public class ConsentDAOUtils {
     ...
     * "key1@@value1||key2@@value2" where keys and values are separated by "@@" and
     ...
     * String[] result = extractAttributeValuesFromResultSet(input);
     * // result will be: ["value1", "value2", "value3"]
     * </pre>
     *
